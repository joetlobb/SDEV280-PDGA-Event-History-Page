import { getRecurringEventCountOnContinualEvent, getPlayerCountOnContinualEvent, getAvgPlayerCountOnContinualEvent } from "./queries.js";

export async function updateStatCards(id) {
  const statData = {};

  const [eventsData, playersData, avgPlayersData] =
    await Promise.all([
